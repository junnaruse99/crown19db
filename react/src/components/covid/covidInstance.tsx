                            ...
                            <p className="card-text">
                                <table className="table">
                                    <tbody>
                                        ...
                                        <CardRow info={{name:"Countries with most cases", description:covid['Country-cases'], condition:true, Component:Link, to:"/country/" + covid['Country-cases'][0]}}/>
                                        <CardRow info={{name:"Countries with most deaths", description:covid['Country-deaths'], condition:(!(covid.Cases === 0  || (covid['Country-deaths'] && covid['Country-deaths'].length === 0))), Component:Link, to:"/country/" + covid['Country-deaths'][0]}}/>
                                        <CardRow info={{name:"Countries with most recovers", description:covid['Country-recovered'], condition:(!(covid.Recovered === 0  || (covid['Country-recovered'] && covid['Country-recovered'].length === 0))), Component:Link, to:"/country/" + covid['Country-recovered'][0]}}/>
