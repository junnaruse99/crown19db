...
class EndpointTest(unittest.TestCase):
    ...
    def test_countries(self):
        ...
        queries = [{'continent':['North America'], 'page':['2'], 'lang': ['English'], 'zone':['-0400'], 'sort':['area'], 'perPage':['2']}]
    ...
    def test_cities(self):
        ...
        queries = [{'population':['1-100000'], 'continent':['Europe'], 'page':['2'], 'sort':['-population'], 'perPage':['5']}]
        for query in queries:
    ...
    def test_covid(self):
        ...
        queries = [{'deaths':['1-100'], 'cases':['1-3000'], 'recovered':['5-8000'], 'sort':['cases', 'recovered', 'deaths']}]
        for query in queries:
